...
lib.ssMetadata = [
		{name:"RECOVER_openChest_demo3_each click_atlas_1", frames: [[0,0,1600,900],[0,902,1600,900]]},
		{name:"RECOVER_openChest_demo3_each click_atlas_2", frames: [[0,0,1600,900],[0,902,1600,900]]},
		{name:"RECOVER_openChest_demo3_each click_atlas_3", frames: [[991,902,628,142],[0,0,1600,900],[0,902,989,768]]}
];
...
(lib.CachedBmp_2 = function() {
	this.initialize(ss["RECOVER_openChest_demo3_each click_atlas_3"]);
	this.gotoAndStop(0);
...
(lib.giphy_0 = function() {
	this.initialize(ss["RECOVER_openChest_demo3_each click_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.giphy_4 = function() {
	this.initialize(ss["RECOVER_openChest_demo3_each click_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.RECOVER_openChest_demo3_eachclick = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_openChest_demo3_each click_atlas_1.png", id:"RECOVER_openChest_demo3_each click_atlas_1"},
		{src:"images/RECOVER_openChest_demo3_each click_atlas_2.png", id:"RECOVER_openChest_demo3_each click_atlas_2"},
		{src:"images/RECOVER_openChest_demo3_each click_atlas_3.png", id:"RECOVER_openChest_demo3_each click_atlas_3"}
	],
	preloads: []
};
