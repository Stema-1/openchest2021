...
lib.ssMetadata = [
		{name:"openChest_demo3_each click v5_atlas_1", frames: [[991,902,628,142],[0,0,1600,900],[0,902,989,768]]},
		{name:"openChest_demo3_each click v5_atlas_2", frames: [[0,0,1600,900],[0,902,1600,900]]},
		{name:"openChest_demo3_each click v5_atlas_3", frames: [[0,0,1600,900],[0,902,1600,900]]},
		{name:"openChest_demo3_each click v5_atlas_4", frames: [[0,0,1083,1660]]}
];
...
(lib.CachedBmp_1 = function() {
	this.initialize(ss["openChest_demo3_each click v5_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.finalshot = function() {
	this.initialize(ss["openChest_demo3_each click v5_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.giphy_0 = function() {
	this.initialize(ss["openChest_demo3_each click v5_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.giphy_4 = function() {
	this.initialize(ss["openChest_demo3_each click v5_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
