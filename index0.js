...
lib.ssMetadata = [
		{name:"index0_atlas_1", frames: [[0,0,1083,1660]]},
		{name:"index0_atlas_2", frames: [[0,0,1600,900],[0,902,1600,900]]},
		{name:"index0_atlas_3", frames: [[0,0,1600,900],[0,902,1600,900]]},
		{name:"index0_atlas_4", frames: [[991,902,628,142],[0,0,1600,900],[0,902,989,768]]}
];
...
(lib.CachedBmp_1 = function() {
	this.initialize(ss["index0_atlas_4"]);
	this.gotoAndStop(0);
...
(lib.finalshot = function() {
	this.initialize(ss["index0_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.giphy_0 = function() {
	this.initialize(ss["index0_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.giphy_4 = function() {
	this.initialize(ss["index0_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index0_atlas_1.png", id:"index0_atlas_1"},
		{src:"images/index0_atlas_2.png", id:"index0_atlas_2"},
		{src:"images/index0_atlas_3.png", id:"index0_atlas_3"},
		{src:"images/index0_atlas_4.png", id:"index0_atlas_4"}
	],
	preloads: []
};
